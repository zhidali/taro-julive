...
Component({
  ...
  methods: {
    ...
    didClickLikeItem() {
      if (
        (this.data.showOrderSuccessAlert && this.data.showCommonAlertType) ||
        !this.data.canClick ||
        this.data.showLoginModal
      )
        return;
    ...
    didClickLike() {
      this.triggerEvent('didClickLike', {});
    },
    didClickShare() {
      this.triggerEvent('didClickShare', {});
    },
    ...
    makeOrder() {
      ...
      order.makeOrder(
        ...
        function () {
          ...
          _this.triggerEvent('showAlertCallback', {});
          _this.setData({
